...
UBC Master of Data Science. Image sourced from [Github](https://github.com/ubc-mds).

Data Science is in the Intersection of Statistics and Computer Science. Venn diagram created by myself with matplotlib_venn and matplotlib.pyplot.

Join a Hackathon with Your Fellow Students! Image sourced from [LinkedIn](https://www.linkedin.com/pulse/every-business-student-should-attend-hackathon-heres-why-tapias/).

There's Lots of Blackboards to Work on Tough Problems. Image sourced from [Harvard University](https://people.math.harvard.edu/~knill/pedagogy/blackboards/index.html).

You Probably Won't Get By Sleeping Through Class! Image sourced from [Sather Health at UC Berkeley](https://www.ocf.berkeley.edu/~sather/the-importance-of-sleeping/).
